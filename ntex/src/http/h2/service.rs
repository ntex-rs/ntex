...
mod openssl {
    ...
    where
        ...
        C::Service: Service<h2::Control<H2Error>, Response = h2::ControlAck>,
        <C::Service as Service<h2::Control<H2Error>>>::Error: StdError,
    ...
    C::InitError: fmt::Debug,
{
    ...
    where
        ...
        <CT::Service as Service<h2::Control<H2Error>>>::Error: StdError,
