...
impl<F, I, Sf, B> HttpServer<NoConfig, F, I, Sf, B>
where
...
impl<Cfg, F, I, Sf, B> HttpServer<Cfg, F, I, Sf, B>
where
    Cfg: ServerAppConfig,
    F: AsyncFn(&Cfg::State) -> I + Send + Clone + 'static,
    I: IntoServiceFactory<Sf, (), Request, SharedCfg>,
