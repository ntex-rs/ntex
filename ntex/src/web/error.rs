    ...
    B: WebResponseError<St, Err>,
{
    fn error_response(&mut self, st: &St, req: &HttpRequest) -> HttpResponse {
        match self {
            Either::Left(a) => a.error_response(st, req),
            Either::Right(b) => b.error_response(st, req),
        }
    }
}
...
mod tests {
    ...
    fn test_other_errors() {
        ...
        let resp =
            WebResponseError::error_response(&mut ClientError::TunnelNotSupported, &(), &req);
